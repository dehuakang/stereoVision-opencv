...
//  stereoVision
//
//  Created by Adam Perkins on 2/28/16.
//  Copyright © 2016 Adam Perkins. All rights reserved.
//

#include "stereoCal.hpp"
...
static void help() {
  ...
  cout << "\nType ./stereoCal --help for more details.\n";
  cout << "\n/******* HELP ENDS *********/\n\n";
}
...
bool findChessboardCornersAndDraw(Mat inputLeft, Mat inputRight) {
  ...
  foundLeft = findChessboardCorners(inputLeft, boardSize, cornersLeft, CALIB_CB_ADAPTIVE_THRESH + CALIB_CB_FILTER_QUADS + CALIB_CB_NORMALIZE_IMAGE + CALIB_CB_FAST_CHECK); //CALIB_CB_ADAPTIVE_THRESH | CALIB_CB_NORMALIZE_IMAGE);
  foundRight = findChessboardCorners(inputRight, boardSize, cornersRight, CALIB_CB_ADAPTIVE_THRESH + CALIB_CB_FILTER_QUADS + CALIB_CB_NORMALIZE_IMAGE + CALIB_CB_FAST_CHECK); //CALIB_CB_ADAPTIVE_THRESH | CALIB_CB_NORMALIZE_IMAGE);
